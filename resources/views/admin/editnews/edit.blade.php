    ...
    <div class="py-12">
        ...
        <div class="container">
            <div class="row mt-3" style="margin-left: 20px">
                ...
                <h1 class="text-center mb-3">News UpdateForm</h1>
                <div class="col-md-12">
                    {{-- <a href="{{route('newsall')}}" class="btn btn-primary mb-3 btn-lg">back</a> --}}

                    <div class="card">
                        <div class="card-header card text-white bg-success mb-1 showtext text-center">Update NEWS</div>
                        <div class="card-body">
                            <form action="{{url('/news/update/'.$news->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-3"  name="title" id="title" cols="30" rows="5">{{$news->title}}</textarea>
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="file" name="image" class="form-control my-2" value="{{$news->image}}">
                                    @error('image')
                                ...
                                <div class="form-group">
                                    <img src="{{asset($news->image)}}" alt="" width="200px" height="200px " class="rounded mx-auto d-block">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mb-3"  name="content" id="content" cols="30" rows="10">{{$news->content}}</textarea>
                                    @error('content')
                                        <div class="my-1">
                                        <span class="text-danger py-2">{{$message}}</span>
                                        </div>
