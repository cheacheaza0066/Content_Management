        ...
        <div class="container">
            <div class="row mt-3" style="margin-left: 20px">
                <ol class="breadcrumb ms-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Popup</li>
                  </ol>
                <h1 class="text-center mb-3">Popup UpdateForm</h1>
                <div class="col-md-12">
                    {{-- <a href="{{route('popupall')}}" class="btn btn-primary mb-3 btn-lg">back</a> --}}

                    <div class="card">
                        <div class="card-header card text-white bg-success mb-1 showtext text-center">UPDATE POPUP</div>
                        <div class="card-body">
                            <form action="{{url('/popup/update/'.$popup->id)}}" method="post" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group">

                                        <label for="image">image</label>
                                        <input type="file" name="image" class="form-control my-2" value="{{$popup->image}}">
                                    @error('image')
                                ...
                                <div class="form-group">
                                    <img src="{{asset($popup->image)}}" alt="" width="200px" height="200px " class="rounded mx-auto d-block">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mb-3"  name="content" id="content" cols="30" rows="10">{{$popup->content}}</textarea>
                                    @error('content')
                                        <div class="my-1">
                                        <span class="text-danger py-2">{{$message}}</span>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="startDate" id="startDate" class="mb-3 form-control" value="{{$popup->startDate}}">    
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="endDate" id="endDate" class="form-control mb-3" value="{{$popup->endDate}}">    
