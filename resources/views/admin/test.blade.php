    ...
    <div class="py-12">
         <div class="wrapper">
                <div class="sidebar col-md-3 col-lg-2 " >
                    <h2>Management</h2>
                    <ul>
                        <li><a class="nav-link active" aria-current="page" href="{{ route('admin.dashbord.user') }}"></i>USER</a></li>
                        <li><a class="nav-link " aria-current="page" href="{{ route('admin.dashbord.news') }}"></i>NEWS</a></li>
                        <li><a class="nav-link " aria-current="page" href="{{ route('admin.dashbord.popup') }}"></i>POPUP</a></li>
                    </ul> 
                </div>
        <div class="container">
